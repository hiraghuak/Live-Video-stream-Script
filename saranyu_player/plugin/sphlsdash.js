...
SaranyuHlsHTML5Player.MediaPlayer.prototype = {
	...
	_buildvolume: function () {
		...
		var a = '<div class="voume_slider_box"><div class="sp-volume-slider sp-volume-slider-wrap"><div class="sp-volume-current"></div><div class="sp-volume-handle"><span class="tooltiptext" style="display:none;" ></span></div></div></div>';
		...
		$(c.fullControls.bottomControlBar.bottomPlayerControls.volumebtn).hover(function () {
			...
			if (!$(c.fullControls.bottomControlBar.bottomPlayerControls.volumebtn).is(":hover") || !$(c.fullControls.bottomControlBar.bottomPlayerControls.volumeSlider).is(":hover")) {
				c.fullControls.bottomControlBar.bottomPlayerControls.volumeSlider.hide()
			}
		});
	...
	_buildprogressbar: function () {
		...
		function showToolTip(e) {
			...
			var seekTotal = t.fullControls.bottomControlBar.bottomPlayerControls.progressbar,
				totalOffset = seekTotal.offset();
			var railWidth = seekTotal.width(),
				pos = e.pageX - totalOffset.left;
			var newTime;
		...
		if (options.advertisement) {
			...
			t._buildadvertisement._buildadvolume = function () {
				...
				t.adContainer.adBottomControls.volumeSlider.handleVolumeMove = function (e) {
					var volume = null,
						volumeTotal = t.adContainer.adBottomControls.volumeSlider,
